      ...
      <div className="rounded-xl border border-white/10 bg-white/[0.02] p-5 mb-5">
        ...
        <div className="grid grid-cols-1 gap-3 text-sm md:grid-cols-3">
          <div className="rounded-lg border border-white/10 bg-black/20 p-4">
            ...
            <p className="text-slate-500 leading-relaxed">它寫著「要怎麼做」：讀哪些資料、怎麼整理、怎麼檢查、產出什麼檔案。</p>
          </div>
          <div className="rounded-lg border border-white/10 bg-black/20 p-4">
            <div className="text-slate-300 font-medium mb-2">CLI 是操作入口</div>
            <p className="text-slate-500 leading-relaxed">它定義「怎麼叫它做」：用什麼 command、帶哪些選項、成功失敗怎麼回報。</p>
          </div>
          <div className="rounded-lg border border-white/10 bg-black/20 p-4">
            <div className="text-slate-300 font-medium mb-2">實務上常在一起</div>
            <p className="text-slate-500 leading-relaxed">很多 script 會包成 CLI；你不需要先懂程式，只要知道 agent 可以呼叫這個穩定入口。</p>
          </div>
        </div>
      </div>
...
project-weekly auto-send --project SHOP`}
      ...
      <p className="text-slate-400 text-sm leading-relaxed mb-4">
        ...
        你可以用既有 CLI、公司內部工具、API script、export 檔先完成 demo。
