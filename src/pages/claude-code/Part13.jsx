      ...
      <div className="rounded-xl border border-violet-500/20 bg-violet-500/5 p-6">
        ...
        <div className="space-y-2 text-sm">
          {[
            ...
            { slug: 'token-context-economics', point: 'Tool call / tool result 也是對話歷史；context 是工作記憶，不是資料庫，重要狀態放檔案、PR、JIRA、Docs' },
            { slug: 'human-in-the-loop', point: 'HITL 讓 agent 幫人補真相、釐清思緒、解除盲點，再由人做決策' },
            { slug: 'permissions-approval', point: 'Permission / approval 決定 agent 何時能做、何時要先交回人確認' },
            ...
            { slug: 'parallel-agent-team', point: 'Agent Team 與 Codex CLI task / cloud 背景任務都可用來平行協作，但協調成本與 token 成本更高' },
