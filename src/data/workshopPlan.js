export const agenda = [
  ...
  },
  {
    block: '基礎觀念',
    minutes: '10-25',
    title: 'Agent loop、context 與安全邊界',
    focus: '感知、規劃、行動、觀察；context 是工作記憶，不是資料庫；用 approval / permission 控制讀檔、改檔、跑 command。',
    outcome: '學員知道 agent 如何迭代、哪些狀態要落到外部儲存，以及何時要人介入確認。',
  },
  {
    block: '基礎觀念',
    minutes: '25-40',
  ...
  },
  {
    ...
    minutes: '70-110',
    title: 'Demo case 推演',
    focus: '從 13 個真實情境挑 2-3 個現場推演：需求整理、CLI / script 優先路徑、MCP optional、輸出格式、風險控管、HITL checkpoint。',
    outcome: '學員看到 agent 如何用 export 檔、API script、dry-run payload 或 MCP 輔助整理 Google Docs、JIRA、Figma、Calendar、Git repo 等常見流程。',
  },
  {
    block: '收斂',
    minutes: '110-120',
    title: '整理清單與 Q&A',
    focus: '整理 demo 準備項、CLI / script 項、MCP optional 項，以及課後可以先試的低風險 automation。',
